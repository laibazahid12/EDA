...
# First start by exploring the data set go through each data field and there impact on each other.Review the data dictionary.inspect the data and fact sheet that can provide helpful background information.learn about the data and anoma
# lies.
...
# Q 1: Dtypes are non numeric. Two of which are dateandtime and there are no nun values.
...
# 1 The values align with our earlier data discovery, where we noticed that the longest rides are approximately 33 miles.
# 2 Yes, the first two values are significantly higher than the others.
# 3 the most expensive rides are not necessarily the longest ones.
# 
